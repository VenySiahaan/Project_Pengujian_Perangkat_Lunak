...
public class stepDef_KirimPesan {
	...
	public void We_are_on_login_page_and_inputs_correct_data() throws Throwable {
		System.setProperty("webdriver.chrome.driver", "C:\\Program Files\\chrome_baru_pkpl\\chromedriver_win32\\chromedriver.exe");
	...
	public void We_click_send_message() throws Throwable {
		// BUtton Send Message
	    driver.findElement(By.xpath("/html/body/div/div/button/div/div/div[1]")).click();    
	}
